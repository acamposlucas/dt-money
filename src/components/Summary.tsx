  ...
  return (
    <section className="max-w-screen-xl mx-auto px-4 xl:px-0 grid grid-cols-3 gap-8 -mt-20">
      ...
      >
        ...
        <h2 id="entradas-valor" className="text-2xl font-bold text-gray-100">
      ...
      >
        ...
        <h2 id="saidas-valor" className="text-2xl font-bold text-gray-100">
      ...
      >
        ...
        <h1 id="total-valor" className="text-2xl font-bold text-gray-100">
